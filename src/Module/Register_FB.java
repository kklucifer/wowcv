...
public class Register_FB {
	 ...
	 public void Register_FB_Test() {
			...
			System.out.println(pro.getProperty("facebook_account"));
			String email= pro.getProperty("facebook_account");
			...
			Module.Check_Email.gmail(pro.getProperty("facebook_account"));
