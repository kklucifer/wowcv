...
public class Create_JA_Anonymous_Jobdetail {
			 ...
			 InputStream input = null;
			  @Test
			  public void Create_JA_Anonymous_JobDetail_Test() {
				  ...
				  driver.findElement(By.xpath("//*[@id=\"topJob\"]/div/div/div/div[1]")).click();
				  try {
					Thread.sleep(500);
				  ...
				  String email = pro.getProperty("email_anonymous_jobdetail");
